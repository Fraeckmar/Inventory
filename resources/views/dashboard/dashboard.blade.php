        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-6">
            ...
            <div class="bg-gradient-to-b from-red-200 to-red-100 border-b-4 border-red-500 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1">
                        <h2 class="font-bold uppercase text-gray-600"><a href="{{ url('/items') }}" class="no-underline hover:text-red-500">{{ __('Items') }}</a></h2>
                        <p class="font-bold text-3xl"> {{ $items }} <span class="text-red-500"><i class="fas fa-caret-up"></i></span></p>
                    </div>
                </div>
            </div>
            <!--/Metric Card-->
