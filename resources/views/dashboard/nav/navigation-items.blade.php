    ...
    @if (in_array(Auth::user()->role, ['administrator', 'staff']))
        ...
        <li class="menu-item mr-3 flex-1 p-2 sm:p-0">
            <a href="{{ url('dashboard') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-purple-400 @if(request()->is('dashboard')) text-purple-400 @endif">
                <i class="fas fa-chart-bar pr-0 md:pr-3 fa-2x h-5"></i><span class="inline pb-1 md:pb-0 text-sm md:text-base">{{ __('Statistics') }}</span>
            </a>
        </li>
        <li class="menu-item mr-3 flex-1 p-2 sm:p-0">
            <a href="{{ url('orders') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-purple-400 @if(request()->is('order')) text-purple-400 @endif">
        ...
        {{-- Customers --}}
        <li class="menu-item mr-3 flex-1 p-2 sm:p-0">
            <a href="{{ url('/users') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-purple-400 @if(request()->is('users')) text-purple-400 @endif">
